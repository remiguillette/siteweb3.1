        ...
        <Link href="/" className="flex items-center space-x-4">
          ...
          <div className="flex flex-col">
            <div className="flex items-center space-x-1">
              ...
              <span className={`text-[#ff6b35] text-4xl font-bold transition-all duration-700 delay-200 ${isLoaded ? 'header-logo-guillette' : 'opacity-0 translate-x-[20px]'}`}>Guillette</span>
            </div>
            <p className={`text-[#ff6b35] text-2xl font-bold whitespace-nowrap transition-all duration-700 delay-400 ${isLoaded ? 'header-logo-groupe' : 'opacity-0 translate-y-[10px]'}`}>Groupe</p>
            <p className={`text-[#ff6b35] text-2xl font-bold whitespace-nowrap transition-all duration-700 delay-600 ${isLoaded ? 'header-logo-group' : 'opacity-0 translate-y-[10px]'}`}>Group</p>
          </div>
        </Link>
